...
| Nueva reserva (`D-046`) | Centered dialog | Fecha (native date input, today to 12 months) · Módulo: Mediodía 10 a 17 h / Noche 19 a 02 h / Día completo 10 a 02 h, taken ones disabled and marked **"Ocupado"** · "Nombre de quien reserva" (required) · "Teléfono (opcional)" with a fixed **+54** · **Volver** / **Guardar reserva**. Errors under each field with a drawn "!" |
